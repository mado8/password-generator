...
let inputlength = prompt('How many characters would you like your password?', '16');
 //length of password
...
let inputupper = prompt('Would you like to include uppercase letters in your password? Type yes or no.');  
let inputlower = prompt('Would you like to include lowercase letters in your password? Type yes or no.');
let inputsymbol = prompt('Would you like to include symbols in your password? Type yes or no.');
let inputnumber = prompt('Would you like to include numbers in your password? Type yes or no.');
...
function generatePassword() {
  generateBtn.addEventListener("click", promptBtnFunc)
}
